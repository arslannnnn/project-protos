...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\x0fListTasksByUser\x12\x1c.task.ListTasksByUserRequest\x1a\x1d.task.ListTasksByUserResponseB6Z4github.com/arslannnnn/project-protos/proto/task;taskb\x06proto3"
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	9,  // 6: task.TaskService.GetTask:input_type -> task.GetTaskRequest
	...
	7,  // 9: task.TaskService.ListTasks:input_type -> task.ListTasksRequest
	...
	10, // 12: task.TaskService.GetTask:output_type -> task.GetTaskResponse
	4,  // 13: task.TaskService.UpdateTask:output_type -> task.UpdateTaskResponse
	6,  // 14: task.TaskService.DeleteTask:output_type -> task.DeleteTaskResponse
	8,  // 15: task.TaskService.ListTasks:output_type -> task.ListTasksResponse
